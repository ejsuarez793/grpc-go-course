...
func (x *CreatBlogRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreatBlogRequest) ProtoMessage() {}

func (x *CreatBlogRequest) ProtoReflect() protoreflect.Message {
	mi := &file_blog_blogpb_blog_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreatBlogRequest.ProtoReflect.Descriptor instead.
func (*CreatBlogRequest) Descriptor() ([]byte, []int) {
	return file_blog_blogpb_blog_proto_rawDescGZIP(), []int{1}
}

func (x *CreatBlogRequest) GetBlog() *Blog {
	if x != nil {
		return x.Blog
	}
	return nil
...
var file_blog_blogpb_blog_proto_rawDesc = []byte{
	...
	0x65, 0x6e, 0x74, 0x22, 0x32, 0x0a, 0x10, 0x43, 0x72, 0x65, 0x61, 0x74, 0x42, 0x6c, 0x6f, 0x67,
	...
	0x67, 0x2e, 0x42, 0x6c, 0x6f, 0x67, 0x52, 0x04, 0x62, 0x6c, 0x6f, 0x67, 0x32, 0xc7, 0x02, 0x0a,
	0x0b, 0x42, 0x6c, 0x6f, 0x67, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x3e, 0x0a, 0x0a,
	0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x42, 0x6c, 0x6f, 0x67, 0x12, 0x16, 0x2e, 0x62, 0x6c, 0x6f,
	0x67, 0x2e, 0x43, 0x72, 0x65, 0x61, 0x74, 0x42, 0x6c, 0x6f, 0x67, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x67, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x3b, 0x0a, 0x08, 0x4c, 0x69, 0x73,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x30, 0x01, 0x42, 0x0e, 0x5a, 0x0c, 0x2f, 0x62, 0x6c, 0x6f, 0x67, 0x2f,
...
var file_blog_blogpb_blog_proto_goTypes = []interface{}{
	...
	(*CreatBlogRequest)(nil),   // 1: blog.CreatBlogRequest
...
var file_blog_blogpb_blog_proto_depIdxs = []int32{
	0,  // 0: blog.CreatBlogRequest.blog:type_name -> blog.Blog
	...
	1,  // 6: blog.BlogService.CreateBlog:input_type -> blog.CreatBlogRequest
