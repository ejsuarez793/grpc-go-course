...
import (
	...
	"github.com/ejsuarez793/grpc-go-course/greet/greetpb"
...
func main() {
	...
	if tls {
		fmt.Println("SSL Enabled in Client")
...
func doUnary(c greetpb.GreetServiceClient) {
	...
	req := greetpb.GreetRequest{Gretting: &greetpb.Greeting{FirstName: "Kike", LastName: "Suarez"}}
...
func doUnaryCallWithDeadline(c greetpb.GreetServiceClient, timeout time.Duration) {
	...
	req := &greetpb.GreetWithDeadlineRequest{Gretting: &greetpb.Greeting{FirstName: "Kike", LastName: "Suarez"}}
