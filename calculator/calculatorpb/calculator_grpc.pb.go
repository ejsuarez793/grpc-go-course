...
type CalculatorServiceClient interface {
	...
	Decompose(ctx context.Context, in *PrimeNumberDecompositionRequest, opts ...grpc.CallOption) (CalculatorService_DecomposeClient, error)
...
func (c *calculatorServiceClient) Decompose(ctx context.Context, in *PrimeNumberDecompositionRequest, opts ...grpc.CallOption) (CalculatorService_DecomposeClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[0], "/main.CalculatorService/Decompose", opts...)
	if err != nil {
		return nil, err
	}
...
type CalculatorService_DecomposeClient interface {
	Recv() (*PrimeNumberDecompositionReponse, error)
	grpc.ClientStream
}
...
func (x *calculatorServiceDecomposeClient) Recv() (*PrimeNumberDecompositionReponse, error) {
	m := new(PrimeNumberDecompositionReponse)
...
func (c *calculatorServiceClient) Max(ctx context.Context, opts ...grpc.CallOption) (CalculatorService_MaxClient, error) {
	stream, err := c.cc.NewStream(ctx, &CalculatorService_ServiceDesc.Streams[2], "/main.CalculatorService/Max", opts...)
	if err != nil {
		return nil, err
	}
...
func (c *calculatorServiceClient) SquareRoot(ctx context.Context, in *SquareRootRequest, opts ...grpc.CallOption) (*SquareRootResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/main.CalculatorService/SquareRoot", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CalculatorServiceServer interface {
	...
	Decompose(*PrimeNumberDecompositionRequest, CalculatorService_DecomposeServer) error
...
func (UnimplementedCalculatorServiceServer) Decompose(*PrimeNumberDecompositionRequest, CalculatorService_DecomposeServer) error {
...
type CalculatorService_DecomposeServer interface {
	Send(*PrimeNumberDecompositionReponse) error
	grpc.ServerStream
}
...
func (x *calculatorServiceDecomposeServer) Send(m *PrimeNumberDecompositionReponse) error {
...
func _CalculatorService_SquareRoot_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/main.CalculatorService/SquareRoot",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
